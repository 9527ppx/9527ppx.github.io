...
## C++透视组件实现
1. 创建组件类
    ![alt text](实现类似于影之刃物体透视功能/image-5.png)
2. 具体代码实现  
    .h文件
    ``` C++
...
1. 找到静态网格体材质  
    例如：
    ![alt text](实现类似于影之刃物体透视功能/image.png)
2. 进入材质
    ![alt text](实现类似于影之刃物体透视功能/image-1.png)
    ![alt text](实现类似于影之刃物体透视功能/image-2.png)
3. 实现MF_OccMask
    1. 创建材质函数
    ![alt text](实现类似于影之刃物体透视功能/image-3.png)
    2. 具体实现
    ![alt text](实现类似于影之刃物体透视功能/image-4.png)
## 组件添加到角色上
1. 打开角色添加组件
    ![alt text](实现类似于影之刃物体透视功能/image-6.png)
2. 点击组件配置参数
    ![alt text](实现类似于影之刃物体透视功能/image-7.png)
    - Check Interval 检测间隔
